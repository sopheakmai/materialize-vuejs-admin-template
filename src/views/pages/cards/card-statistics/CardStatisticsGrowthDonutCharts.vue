...
const chartOptions = computed(() => {
  ...
  return {
    legend: { show: false },
    stroke: { width: 5, colors: ['rgba(var(--v-theme-surface), 1)'] },
    colors: [currentTheme.primary, currentTheme.success, currentTheme.secondary],
        ...
        donut: {
          ...
          labels: {
            ...
            total: {
              ...
              fontSize: '1rem',
              color: textSecondary,
              formatter: (val: unknown) => (typeof val === 'string' ? `${val}%` : '12%'),
            },
            value: {
              offsetY: 6,
              fontWeight: 600,
