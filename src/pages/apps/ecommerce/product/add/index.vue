...
const inventoryTabsData = [
  ...
  { icon: 'ri-car-line', title: 'Shipping', value: 'Shipping' },
  { icon: 'ri-global-line', title: 'Global Delivery', value: 'Global Delivery' },
  { icon: 'ri-link-m', title: 'Attributes', value: 'Attributes' },
