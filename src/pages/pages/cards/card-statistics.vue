...
import CardStatisticsSalesProfitCharts from '@/views/pages/cards/card-statistics/CardStatisticsSalesProfitCharts.vue'
...
<template>
  <VRow>
    ...
    <VCol
      ...
      lg="3"
    >
      <CardStatisticsSalesProfitCharts />
    </VCol>
    ...
    <!-- 👉 Weekly Sales card with background color -->
    <VCol
      cols="12"
      md="6"
    >
