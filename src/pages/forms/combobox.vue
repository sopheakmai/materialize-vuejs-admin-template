  ...
  <VRow class="match-height">
    ...
    >
      ...
      <AppCardCode
        ...
        :code="variant"
      >
        <p>Use <code>solo</code>, <code>outlined</code>, <code>underlined</code>, <code>filled</code> and <code>plain</code> options of z<code>variant</code> prop to change the look of combobox. </p>
